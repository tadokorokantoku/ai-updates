...
highlights:
  - "Added arrow key history navigation in vim normal mode when cursor cannot move..."
  - "Added external editor shortcut (Ctrl+G) to the help menu for better discovera..."
---
