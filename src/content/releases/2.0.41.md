...
highlights:
  - "Added `model` parameter to prompt-based stop hooks, allowing users to specify..."
  - "Fixed slash commands from user settings being loaded twice, which could cause..."
---
