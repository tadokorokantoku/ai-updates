...
highlights:
  - "Added support for Amazon Bedrock powered by Mantle, set `CLAUDE_CODE_USE_MANT..."
  - "Changed default effort level from medium to high for API-key, Bedrock/Vertex/..."
---
