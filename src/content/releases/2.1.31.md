...
highlights:
  - "Added session resume hint on exit, showing how to continue your conversation ..."
  - "Added support for full-width (zenkaku) space input from Japanese IME in check..."
---
