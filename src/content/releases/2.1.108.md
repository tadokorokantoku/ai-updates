...
highlights:
  - "Added `ENABLE_PROMPT_CACHING_1H` env var to opt into 1-hour prompt cache TTL ..."
  - "Added recap feature to provide context when returning to a session, configura..."
---
