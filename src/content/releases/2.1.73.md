...
highlights:
  - "Added `modelOverrides` setting to map model picker entries to custom provider..."
  - "Added actionable guidance when OAuth login or connectivity checks fail due to..."
---
