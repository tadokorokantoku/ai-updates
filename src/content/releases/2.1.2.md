...
highlights:
  - "Added source path metadata to images dragged onto the terminal, helping Claud..."
  - "Added clickable hyperlinks for file paths in tool output in terminals that su..."
---
