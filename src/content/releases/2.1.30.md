...
highlights:
  - "Added `pages` parameter to the Read tool for PDFs, allowing specific page ran..."
  - "Added pre-configured OAuth client credentials for MCP servers that don't supp..."
---
